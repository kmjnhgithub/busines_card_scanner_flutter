...
abstract class CardReader {
  ...
  ///
  /// 回傳符合搜尋條件的名片列表
  Future<List<BusinessCard>> searchCards(String query, {int limit = 50});
  ...
  ///
  /// 回傳分頁結果，包含頁數資訊
  Future<CardPageResult> getCardsPage({int page = 1, int pageSize = 20});
}
...
/// 名片排序欄位
enum CardSortField { createdAt, updatedAt, name, company }
