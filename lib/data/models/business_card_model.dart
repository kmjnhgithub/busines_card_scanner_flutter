...
class BusinessCardModel with _$BusinessCardModel {
  const factory BusinessCardModel({
    ...
    @JsonKey(name: 'created_at') required DateTime createdAt, @JsonKey(name: 'updated_at') required DateTime updatedAt, @JsonKey(name: 'name_phonetic') String? namePhonetic,
  ...
  factory BusinessCardModel.fromJson(Map<String, dynamic> json) {
    ...
    if (!json.containsKey('id') || json['id'] == null || json['id'].toString().isEmpty) {
      throw const FormatException('BusinessCardModel requires non-empty id field');
    }
    if (!json.containsKey('name') || json['name'] == null || json['name'].toString().isEmpty) {
      throw const FormatException('BusinessCardModel requires non-empty name field');
    }
  ...
  factory BusinessCardModel.fromEntity(BusinessCard entity) {
    return BusinessCardModel(
      ...
      updatedAt: entity.updatedAt ?? entity.createdAt, // 如果 updatedAt 為空，使用 createdAt
    );
  }
}
