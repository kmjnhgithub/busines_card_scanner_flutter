...
class ValidationService {
    ...
    if (!_companyNameRegex.hasMatch(trimmedName)) {
      return Left(
        ValidationFailure(
          ...
          internalMessage:
              'Company name contains invalid characters: $trimmedName',
          field: 'companyName',
        ),
      );
    }
  ...
  /// 驗證最小長度
  Either<ValidationFailure, String> validateMinLength(
    String text,
    int minLength,
  ) {
  ...
  /// 驗證最大長度
  Either<ValidationFailure, String> validateMaxLength(
    String text,
    int maxLength,
  ) {
  ...
  /// 驗證長度範圍
  Either<ValidationFailure, String> validateLengthRange(
    String text,
    int minLength,
    int maxLength,
  ) {
  ...
  /// 驗證必填欄位
  Either<ValidationFailure, String> validateRequired(
    String text,
    String fieldName,
  ) {
