...
class QuickActionBar extends StatelessWidget {
  ...
  ActionConfig _getActionConfig(CardAction action) {
    switch (action) {
      case CardAction.view:
        return const ActionConfig(icon: Icons.visibility_outlined, title: '檢視');

      case CardAction.edit:
        return const ActionConfig(icon: Icons.edit_outlined, title: '編輯');

      case CardAction.share:
        return const ActionConfig(icon: Icons.share_outlined, title: '分享');

      case CardAction.duplicate:
        return const ActionConfig(icon: Icons.copy_outlined, title: '複製');

      case CardAction.export:
        return const ActionConfig(icon: Icons.download_outlined, title: '匯出');
