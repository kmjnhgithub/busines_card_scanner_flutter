  ...
  group('DeleteCardUseCase Tests', () {
    ...
    group('硬刪除功能', () {
      test('should delete single card successfully', () async {
        ...
        // Act
        final result = await useCase.execute(DeleteCardParams(
          cardId: cardId,
      ...
      test('should validate card ID before deletion', () async {
        ...
        // Act & Assert
        expect(
          () => useCase.execute(DeleteCardParams(
            cardId: emptyCardId,
            deleteType: DeleteType.hard,
          )),
    ...
    group('軟刪除功能', () {
      ...
      test('should support restore functionality after soft delete', () async {
        ...
        // Act
        final result = await useCase.executeRestore(RestoreCardParams(
          cardId: cardId,
        ));
    ...
    group('清理功能', () {
      test('should purge old deleted cards successfully', () async {
        ...
        // Act
        final result = await useCase.executePurge(PurgeDeletedCardsParams(
          daysOld: 30,
        ));
      ...
      test('should validate purge parameters', () async {
        ...
        // Act & Assert
        expect(
          () => useCase.executePurge(PurgeDeletedCardsParams(
            daysOld: invalidDays,
          )),
          throwsA(isA<InvalidInputFailure>()),
        );
