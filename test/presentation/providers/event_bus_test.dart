  ...
  group('EventBus Provider Tests', () {
    ...
    group('事件發布和訂閱機制', () {
      ...
      test('should only receive events of subscribed type', () async {
        ...
        final userSubscription = eventBus.on<UserEvent>().listen(userEvents.add);
    ...
    group('領域事件整合', () {
      test('should handle domain events from business logic', () async {
        ...
        final subscription = eventBus.on<CardCreatedEvent>().listen(domainEvents.add);
      ...
      test('should support event filtering and transformation', () async {
        ...
        // Act
        eventBus.emit(CardCreatedEvent(
          cardId: 'card_1',
          cardName: '張三',
          timestamp: DateTime.now(),
        ));
    ...
    group('效能和記憶體管理', () {
      ...
      test('should clean up subscriptions on provider override', () {
        ...
        final newContainer = ProviderContainer(
          overrides: [
            eventBusProvider.overrideWith((ref) => EventBusImpl()),
          ],
        );
...
class TestEvent extends BaseEvent {
  ...
  bool operator ==(Object other) =>
      ...
      other is TestEvent && runtimeType == other.runtimeType && data == other.data;
...
class UserEvent extends BaseEvent {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is UserEvent && runtimeType == other.runtimeType && data == other.data;
...
class CardCreatedEvent extends BaseEvent {
  ...
  @override
  String toString() => 'CardCreatedEvent{cardId: $cardId, cardName: $cardName, timestamp: $timestamp}';
}